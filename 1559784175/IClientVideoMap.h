class IClientVideoMap
{
	...
	virtual void InviteToBroadcast( CSteamID, bool, uint32 ) = 0;
	virtual void IgnoreApprovalRequest( CSteamID, uint32 ) = 0;
	...
	virtual void AddBroadcastGameData( char const*, char const* ) = 0;
	virtual void RemoveBroadcastGameData( char const* ) = 0;
	virtual void AddTimelineMarker( char const*, bool, uint8, uint8, uint8 ) = 0;
	virtual void RemoveTimelineMarker() = 0;
	virtual void * AddRegion( char const*, char const*, SteamTVRegion_t const*, ESteamTVRegionBehavior ) = 0;
	virtual void RemoveRegion( uint32 ) = 0;
	...
	virtual void WebRTCGetTURNAddress( CUtlString * ) = 0;
	virtual void WebRTCStartResult( uint64, bool, char const* ) = 0;
	virtual void WebRTCAddCandidate( uint64, char const*, int32, char const* ) = 0;
	virtual void WebRTCGetAnswer( uint64, CUtlString * ) = 0;
};
