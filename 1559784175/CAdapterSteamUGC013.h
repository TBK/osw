class CAdapterSteamUGC013
{
	...
	virtual unknown_ret CreateQueryAllUGCRequest( EUGCQuery, EUGCMatchingUGCType, uint32, uint32, char const* ) = 0;
	...
	virtual unknown_ret GetQueryUGCKeyValueTag( uint64, uint32, char const*, char *, uint32 ) = 0;
	...
	virtual unknown_ret SetAllowLegacyUpload( uint64, bool ) = 0;
	virtual unknown_ret RemoveAllItemKeyValueTags( uint64 ) = 0;
