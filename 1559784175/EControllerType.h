enum EControllerType
{
	...
	k_EControllerTypeController_mobile_touch = 43,	// controller_mobile_touch
	...
	k_EControllerTypeController_switch_pro_generic = 42,	// controller_switch_pro_generic
	k_EControllerTypeController_mobile_touch,	// controller_mobile_touch
	k_EControllerTypeController_ps4 = 4,	// controller_ps4
}
