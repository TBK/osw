class CAdapterSteamHTMLSurface005
{
	virtual unknown_ret ~CAdapterSteamHTMLSurface005() = 0;
	virtual unknown_ret ~CAdapterSteamHTMLSurface005() = 0;
	...
	virtual unknown_ret KeyDown( uint32, uint32, ISteamHTMLSurface::EHTMLKeyModifiers, bool ) = 0;
	...
	virtual unknown_ret OpenDeveloperTools( uint32 ) = 0;
