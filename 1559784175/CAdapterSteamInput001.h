class CAdapterSteamInput001
{
	...
	virtual unknown_ret GetDigitalActionOrigins( uint64, uint64, uint64, EInputActionOrigin * ) = 0;
	virtual unknown_ret GetAnalogActionHandle( char const* ) = 0;
	virtual unknown_ret GetAnalogActionData( uint64, uint64 ) = 0;
	virtual unknown_ret GetAnalogActionOrigins( uint64, uint64, uint64, EInputActionOrigin * ) = 0;
	...
	virtual unknown_ret GetActionOriginFromXboxOrigin( uint64, EXboxOrigin ) = 0;
	virtual unknown_ret TranslateActionOrigin( ESteamInputType, EInputActionOrigin ) = 0;
	virtual unknown_ret GetDeviceBindingRevision( uint64, int32 *, int32 * ) = 0;
};
