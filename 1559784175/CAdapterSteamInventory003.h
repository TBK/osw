class CAdapterSteamInventory003
{
	...
	virtual unknown_ret GetItemsWithPrices( int32 *, uint64 *, uint64 *, uint32 ) = 0;
	virtual unknown_ret GetItemPrice( int32, uint64 *, uint64 * ) = 0;
