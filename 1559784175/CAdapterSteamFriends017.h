class CAdapterSteamFriends017
{
	...
	virtual unknown_ret GetFriendsGroupIDByIndex( int32 ) = 0;
	virtual unknown_ret GetFriendsGroupName( int16 ) = 0;
	...
	virtual unknown_ret ActivateGameOverlayToStore( uint32, EOverlayToStoreFlag ) = 0;
